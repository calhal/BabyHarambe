...
contract SafemoonFork is Context, IERC20, Ownable {
    ...
    string private _name = "BabyHambre";      //CHANGE_REQUIRED: name of token
    string private _symbol = "BABYH";    //CHANGE_REQUIRED: ticker of token, usually 3 letter
    uint8 private _decimals = 9;                //CHANGE_OPTIONAL: number of decimals of your token. Recommended to keep unchanged 
    
    uint256 public _taxFee = 2;                 //CHANGE_OPTIONAL: transaction fee redistributed to all holders
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _liquidityFee = 2;           //CHANGE_OPTIONAL: transaction fee sent to Pancakeswap pool
    uint256 private _previousLiquidityFee = _liquidityFee;
    
    uint256 public _burnFee = 1;           //CHANGE_OPTIONAL: transaction fee sent to Pancakeswap pool
    uint256 private _previousBurnFee = _burnFee;
    address public _burnAddress = address(0x0000000000000000000000000000000000000000);
